...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-r from-secondary/40 via-white to-soft-pink/40">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 max-w-xl">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-playfair font-bold leading-tight">
                ...
                <span className="text-primary"> изысканных ароматов</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-600">
                Погрузитесь в атмосферу гармонии и комфорта с нашей коллекцией ароматов для дома и натуральной косметики
              </p>
            </div>
            
            <div className="flex flex-wrap gap-4">
              <Button asChild className="hero-button bg-primary hover:bg-primary/90 text-white">
                <Link to="/products">
                  Смотреть коллекцию <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" className="hero-button border-primary text-primary hover:bg-primary/5">
                <Link to="/about">
                  О нашем бренде
                </Link>
              </Button>
            ...
            <div className="flex items-center space-x-6 pt-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Более 500+ довольных клиентов</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1616486409317-6b898be0e8e2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                alt="Home Fragrance Collection" 
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-lg p-4 shadow-lg max-w-xs">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-sm">100% натуральные компоненты</h4>
                  <p className="text-xs text-gray-500">Безопасно для вас и окружающей среды</p>
                </div>
              </div>
            </div>
          </div>
